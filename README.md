...
**Both suites are green: backend 2,171 passed, frontend 251 passed, 0 failed** — across
188 backend and 50 frontend test files. Every guard listed above is mutation-tested:
