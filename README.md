...
rules, each written after a defect that a weaker check had missed. Rules 21–197 are recorded in
...
uvicorn and drives all 525 documented operations with generated input (~8 min):
