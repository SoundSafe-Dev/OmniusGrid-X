...
**Both suites are green: backend 2,166 passed, frontend 251 passed, 0 failed** — across
187 backend and 50 frontend test files. Every guard listed above is mutation-tested:
