...
rules, each written after a defect that a weaker check had missed. Rules 21–203 are recorded in
...
```bash
cd backend && pytest          # 4,500+ pass, ~100 skip. Docker is OPTIONAL: the real-DB
...
uvicorn and drives all 526 documented operations with generated input (~8 min):
