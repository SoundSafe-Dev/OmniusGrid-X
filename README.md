...
rules, each written after a defect that a weaker check had missed. Rules 21–213 are recorded in
...
uvicorn and drives all 546 documented operations with generated input (~8 min):
