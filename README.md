...
rules, each written after a defect that a weaker check had missed. Rules 21–299 are recorded in
...
```bash
cd backend && pytest          # 5,600+ pass, ~110 skip. Docker is OPTIONAL: the real-DB
