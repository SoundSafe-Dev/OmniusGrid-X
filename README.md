...
**Both suites are green: backend 2,186 passed, frontend 253 passed, 0 failed** — across
189 backend and 50 frontend test files. Every guard listed above is mutation-tested:
