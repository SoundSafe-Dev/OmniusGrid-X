...
const SCENES: {
  ...
  { id: 'CorrelationIntro', comp: MobileCorrelationIntroScene, duration: 165, transition: 'slide-l' },
  { id: 'Correlation', comp: MobileCorrelationScene, duration: 545, transition: 'fade' },
  { id: 'Intake', comp: MobileIntakeScene, duration: 135, transition: 'slide-l' },
  { id: 'AssetsDetail', comp: MobileAssetsDetailScene, duration: 240, transition: 'slide-l' },
  { id: 'Dashboard', comp: MobileDashboardScene, duration: 150, transition: 'slide-l' },
  { id: 'OEE', comp: MobileOEEScene, duration: 165, transition: 'slide-l' },
  { id: 'Logistics', comp: MobileLogisticsScene, duration: 200, transition: 'fade' },
  { id: 'Yard', comp: MobileYardScene, duration: 160, transition: 'slide-l' },
  { id: 'ERP', comp: MobileERPScene, duration: 150, transition: 'fade' },
  { id: 'Kanban', comp: MobileKanbanScene, duration: 210, transition: 'slide-l' },
  { id: 'CorrelationReturn', comp: MobileCorrelationReturnScene, duration: 155, transition: 'wipe' },
