...
from app.db.models import UUIDString
...
class NotificationSubscription(Base):
    ...
    id = UUIDColumn()
    organization_id = Column(UUIDString(), nullable=False, index=True)
    ...
    asset_id = Column(UUIDString(), nullable=True)        # optional filter
...
class NotificationDelivery(Base):
    ...
    id = UUIDColumn()
    organization_id = Column(UUIDString(), index=True)
    subscription_id = Column(UUIDString(), index=True)
