"""Infor correlation patterns (FS-55x).

WHY THIS FILE EXISTS. Infor has a working connector, stores raw records, and
...
The analyzers below read what `ERPDataTransformer.transform_infor_*` produces, field
...
class InforCorrelationPatterns:
    ...
    def __init__(self, organization_id: str, integration_id: str):
        ...
        logger.info(
            "infor_correlation_patterns_initialized",
    ...
    def _result(
        ...
        return {
            ...
            "entity_id": entity_id,
            "domain": self.INFOR_DOMAIN_MAPPINGS.get(entity_type),
            "anomalies": anomalies,
