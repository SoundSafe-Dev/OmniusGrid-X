...
async def _session_factory():
    ...
    await create_all(engine, Base.metadata, [GeoTabTrip.__table__, GeoTabException.__table__])
...
async def _seed(session, org_id):
    # The organisation the rows below belong to. With foreign keys enforced (FS-410) a bare
